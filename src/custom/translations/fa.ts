...
export const fa: LangType = {
    ...
    'page.body.trade.header.newOrder.content.filterPrice': ' مقدار صحیح قیمت {priceStep}',

    'error.order.create.minAmount': 'می باشد {amount} {currency} مقدار تعیین شده پایین است. حداقل مقدار قابل قبول',
    'error.order.create.minPrice': 'می باشد {price} {currency} قیمت تعیین شده پایین است. حداقل قیمت قابل قبول',
    'error.order.create.maxPrice': 'می باشد {price} {currency} قیمت تعیین شده بالا است. حداکثر قیمت قابل قبول',
    ...
    'page.body.landing.marketInfo.title.text1': 'به بازار معاملاتی رویان خوش آمدید',
    'page.body.landing.marketInfo.title.text2': 'خرید، فروش و تبادل ارزهای دیجیتال',
    ...
    'page.body.landing.platformInfo.item.second.title': 'حجم معاملاتی در 30 روز گذشته',
    ...
    'page.body.landing.features.features.item3.title': 'رابط کاربری با قابلیت شخصی سازی',
    ...
    'page.body.landing.tradeOnTheGo.item.text2': 'و مجبور نخواهید بود هیچ برنامه ی اضافه ای را دانلود کنید',
    'page.body.landing.tradeOnTheGo.item.text3': 'تمام قدرت این پلتفرم تبادلی در دستان شما قرار دارد',
    ...
    'page.body.wallets.tabs.deposit.ccy.message.error': 'در حال ایجاد آدرس واریزی',
    'page.body.wallets.tabs.deposit.ccy.button.generate': 'ایجاد آدرس جدید',
    'page.body.wallets.tabs.deposit.ccy.button.generate.message': 'درخواست ارسال شد',
    ...
    'page.body.wallets.tabs.deposit.fiat.message2': 'برای مبالغ بالا با پشتیبانی مطرح کنید',
    ...
    'page.body.wallets.tabs.deposit.fiat.admin': 'برای برداشت پول فیات، لطفاً با ادمین تماس بگیرید',
    ...
    'page.body.wallets.tabs.withdraw.content.code2fa.sms': 'کد یکبار مصرف پیامکی',
    ...
    'page.body.wallets.tabs.withdraw.modal.message1': ' پس از تایید شما به ادرس انتخابی',
    'page.body.wallets.tabs.withdraw.modal.message2': 'واریز خواهد شد',
    'page.body.wallets.tabs.withdraw.modal.message3': ' پس از تایید شما به شماره حساب',
    'page.body.wallets.tabs.withdraw.modal.button.cancel': 'انصراف',
    'page.body.wallets.tabs.withdraw.modal.button.withdraw': 'برداشت',

    'page.body.wallets.tabs.withdraw.content.enable2fa': 'برای برداشت ارز باید احراز هویت دو عاملی را فعال کنید',
    'page.body.wallets.tabs.withdraw.content.enable2faButton': 'فعال سازی',
    'page.body.wallets.tabs.withdraw.disabled.message': 'برداشت این ارز توسط ادمین غیرفعال شده است',
    'page.body.wallets.tabs.withdraw..level.disabled.message': 'برای برداشت لطفا پروفایل خود را کامل کنید',

    'success.beneficiaries.created': 'Beficiaries: به طور موفقیت آمیز ایجاد شد',
    'success.beneficiaries.activated': 'Beficiaries: به طور موفقیت آمیز فعال شد',
    'success.beneficiaries.deleted': 'Beficiaries: به طور موفقیت آمیز حذف گردید',
    ...
    'page.body.wallets.beneficiaries.addAddressModal.header': 'آدرس جدید برای برداشت اضافه کنید',
    ...
    'page.body.wallets.beneficiaries.addAddressModal.body.button': 'ثبت جهت تأیید',

    'page.body.wallets.beneficiaries.confirmationModal.header': 'تأیید آدرس جدید',
    ...
    'page.body.profile.header.account.content.password.dont.match': 'رمز عبور مطابقت ندارد',
    'page.body.profile.header.account.content.password.change.success': 'با موفقیت انجام شد!',
    ...
    'page.body.profile.header.account.content.twoFactorAuthentication.header': 'احراز هویت دو عاملی',
    ...
    'page.body.profile.header.account.content.twoFactorAuthentication.message.mfa': 'MFA کد',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.4': 'کد 2FA را از اپلیکیشن وارد کنید.',
    'page.body.profile.header.account.content.twoFactorAuthentication.subHeader': 'کد 2FA',
    'page.body.profile.header.account.content.twoFactorAuthentication.enable': 'فعال کن',
    'page.body.profile.header.account.content.twoFactorAuthentication.copy': 'کپی',
    'page.body.profile.header.account.content.twoFactorAuthentication.disable': 'احراز هویت دو عاملی را غیر فعال کن',
    'page.body.profile.header.account.content.twoFactorAuthentication.modalBody':
        'برای غیر فعال کردن با ادمین تماس بگیرید',
    'page.body.profile.header.account.content.twoFactorAuthentication.modalHeader': 'احراز هویت دو عاملی فعال شد',
    ...
    'page.body.profile.header.account.profile.email.message': 'برداشت و واریز (ارز دیجیتال) فعال شد',
    'page.body.profile.header.account.profile.phone.unverified.title': 'تلفن همراه',
    'page.body.profile.header.account.profile.phone.title': 'شماره تلفن تأیید شد',
    'page.body.profile.header.account.profile.phone.message': 'واریز و تبادل فعال شد',
    ...
    'page.body.profile.apiKeys.noOtp': 'لطفاًً احراز هویت دو عاملی را فعال کنید',
 ...
 اگر کلید دستری خود را فراموش کردید، لطفاً آن را حذف کرده و درخواست یک کلید دستری جدید نمایید`,
    ...
    'page.body.profile.header.accountActivity.content.userAgent': 'مرورگر کاربر',
    ...
    'page.body.profile.content.action.enable2fa': 'فعالسازی احراز هویت دو عاملی',
    'page.body.profile.content.action.login.2fa': 'ورود با احراز هویت دو عاملی',
    'page.body.profile.content.action.requestPasswordReset': 'درخواست بازیابی رمز عبور',
    ...
    'page.body.profile.content.bankInfo.modal.submit.error': 'لطفا همه فیلدها را کامل کنید',
    'page.body.profile.content.bankInfo.modal.submit.bankNameError': 'نام بانک را با حروف فارسی وارد کنید',

    'page.body.profile.content.bankInfo.modal.submit.success': 'اطلاعات بانکی شما با موفقیت ثبت شد',
    ...
    'page.body.kyc.documents.uploadFile.selfie.label': 'لطفا تصویر خود را طبق راهنمایی در قسمت سمت چپ انتخاب کنید',
    'page.body.kyc.documents.uploadFile.selfie.button': 'انتخاب تصویر',
    'page.body.kyc.documents.uploadFile.selfie.sizes': 'حداکثر سایز فایل ۲۰ مگابایت',
    ...
    'page.body.kyc.documents.drag': 'می توانید از کشیدن و رها کردن استفاده کرده یا بین فایل ها جستجو کنید',
    ...
    'page.body.referral.cards.statistic.header': 'آمار کاربران معرفی شده توسط شما',
    ...
    'page.body.referral.cards.statistic.inviteduser.transaction': 'تعداد معاملات کاربران مدعو شما',
    'page.body.referral.cards.statistic.inviteduser': 'تعداد کاربران ثبت نامی با کد دعوت شما',
    ...
    'page.body.deposit.online.select.chooseCard': 'کارت بانکی خود را انتخاب کنید',
    'page.body.deposit.online.select.chooseAccNum': 'شماره حساب خود را انتخاب کنید',
    'page.body.deposit.online.button.transform': 'پرداخت',
    'page.body.deposit.online.button.addCard': 'افزودن کارت',
    'page.body.deposit.online.text.read': 'لطفا پیش از واریز وجه، توضیحات زیر را به دقت مطالعه نمایید. ',
    ...
    'page.body.deposit.online.text.payAttention': 'در هنگام پرداخت به نکات زیر دقت نمایید:',
    ...
    'page.body.deposit.online.text.trueAmount': 'در صفحه درگاه دقت کنید که حتما مبلغ نمایش داده شده درست باشد.',
    ...
    'page.body.deposit.offline.select.chooseAccNum': 'شماره حساب مبدا را انتخاب کنید',
    ...
    'page.body.deposit.offline.text.payAttention': 'جهت استفاده از این روش به نکات زیر توجه فرمایید:',
    'page.body.deposit.offline.text.payLevel': 'واریز بانکی صرفا در سطح ۳ امکان پذیر است.',
    'page.body.deposit.offline.text.coordination': 'جهت واریز بانکی حتماً با پشتیبانی هماهنگ نمایید.',
    'page.body.deposit.offline.text.MinTransactionAmount': 'حداقل مبلغ واریزی پنج میلیون تومان می باشد.',
    ...
    'page.body.deposit.offline.text.wage': 'کارمزد واریز بانکی برای کلیه مبالغ واریزی ثابت و چهار هزار تومان است.',
    'page.body.deposit.offline.text.compeleteForm': 'پس از واریز وجه فرم زیر را تکمیل نموده و ارسال نمایید.',
    ...
    'page.body.withdraw.coin.title': 'در صورت تمایل به برداشت موجودی کیف پول‌های خود، درخواست خود را اینجا ثبت نمایید.',
    ...
    'page.body.withdraw.coin.input.title.withdrawalAmount': 'مقدار برداشت ({bitCoin}):',
    'page.body.withdraw.coin.input.title.wage': 'کارمزد انتقال :',
    'page.body.withdraw.coin.input.placeholder.wage': '0.00035 بیت‌کوین',
    'page.body.withdraw.coin.input.withdrawalAmount.total': 'موجودی قابل برداشت شما :',
    'page.body.withdraw.coin.input.withdrawalAmount.daily': 'مجموع برداشت روزانه معادل:',
    'page.body.withdraw.coin.input.withdrawalAmount.monthly': 'مجموع برداشت ماهانه:',
    ...
    // statics:
    'page.body.withdraw.coin.input.withdrawalAmount.total.data.now': '0.00175062',
    'page.body.withdraw.coin.input.withdrawalAmount.daily.data.now': '0',
    'page.body.withdraw.coin.input.withdrawalAmount.monthly.data.now': '48,294,166',
    'page.body.withdraw.coin.input.withdrawalAmount.daily.data.total': '200,000,000',
    'page.body.withdraw.coin.input.withdrawalAmount.monthly.data.total': '3,000,000,000',
    //
    ...
    'page.body.withdraw.fiat.input.title.withdrawalAmount': 'مبلغ برداشت (تومان):',
    ...
    'page.body.withdraw.fiat.input.accountAddress.selectAccountText':
        'می‌توانید هر یک از حساب‌های بانکی تایید شده‌ی خود را برای دریافت وجه انتخاب نمایید. در صورتی که حساب مد نظر شما در این لیست نیست، به پروفایل خود رفته و حساب خود را افزوده و منتظر تایید آن باشید.',
    'page.body.withdraw.fiat.input.wage.text': 'کارمزد انتقال ریال جهت انجام عملیات بانکی است.',
    'page.body.withdraw.fiat.input.withdrawalAmount.total': 'موجودی قابل برداشت شما :',
    'page.body.withdraw.fiat.input.withdrawalAmount.daily': 'مجموع برداشت روزانه:',
    'page.body.withdraw.fiat.input.withdrawalAmount.monthly': 'مجموع برداشت ماهانه:',
    ...
    'page.body.withdraw.fiat.input.withdrawalAmount.monthly.data.now': '48,294,166',
    'page.body.withdraw.fiat.input.withdrawalAmount.daily.data.total': '200,000,000',
    'page.body.withdraw.fiat.input.withdrawalAmount.monthly.data.total': '3,000,000,000',
    //
    ...
    'page.body.fastOrder.label.bitcoinTotalAmount': 'قیمت تمام شده هر بیت‌کوین: ',
    ...
    'page.header.signIn.resetPassword.error': 'برخی قسمت ها خالی هستند یا مطابقت نداشتند',
    ...
    'page.forgotPassword.message': 'برای بازیابی رمز عبور ایمیل خود را وارد کنید',
    ...
    'page.body.customization.themes.color.dropdownBackgroundColor': 'پس زمینه منوی کشویی',
    'page.body.customization.themes.color.icon': 'آیکون ها',
    'page.body.customization.themes.color.primaryCtaColor': 'فرمان انجام اصلی',
    'page.body.customization.themes.color.contrastCtaColor': 'فرمان انجام کنتراست',
    'page.body.customization.themes.color.secondaryContrastCtaColor': 'فرمان انجام کنتراست ثانویه',
    ...
    'page.body.customization.themes.color.strengthMeterVeryStrong': 'رمز عبور بسیار قوی است',
    ...
    'resource.api_key.2fa_disabled': 'تنها حساب های کاربری که احراز هویت دو عاملی خود را فعال کرده اند مجاز هستند',
    'resource.api_key.missing_otp': 'احراز هویت دو عاملی حساب کاربری فعال شده، اما رمز یک بار مصرف وجود ندارد',
    ...
    'resource.phone.verification_invalid': 'شماره تلفن پیدا نشد یا کد تأیید صحیح نیست',
    'resource.documents.limit_reached': 'تعداد مدارک آپلود شده به حداکثر رسیده',
    'resource.documents.limit_will_be_reached': 'با آپلود این مدرک، تعداد مدارک آپلود شده به حداکثر خواهد رسید',
    'resource.otp.already_enabled': 'احراز هویت دو عاملی برای این حساب کاربری از پیش فعال شده',
    ...
    'resource.password.no_change_provided': 'رمز عبور جدید نمی‌تواند با رمز عبور قبلی یکسان باشد',
    ...
    'identity.user.active_or_doesnt_exist': 'کاربر وجود ندارد یا از قبل فعال شده است',
    ...
    'identity.session.missing_otp': 'احراز هویت دو عاملی حساب کاربری فعال شده، اما رمز یک بار مصرف وجود ندارد',
    ...
    'identity.user.missing_reset_password_token': 'توکن بازیابی رمز عبور وجود ندارد',
    'identity.user.empty_reset_password_token': 'توکن بازیابی رمز عبور وجود ندارد',
    ...
    'resource.phone.empty_verification_code': 'کد تأیید وجود ندارد یا وارد نشده',

    // app
    'account.currency.doesnt_exist': 'ارز مورد نظر موجود نیست',
    'account.currency.deposit_disabled': 'واریز به این کیف موقتاً غیرفعال می باشد.',
    'account.deposit.invalid_state': 'وضعیت واریزی صحیح نیست',
    'account.deposit.non_integer_limit': 'مقدار ارسالی نمی‌تواند به شکل اعداد صحیح باشد',
    'account.deposit.invalid_limit': 'محدوده صحیح نیست',
    'account.deposit.non_positive_page': 'مقدار صفحه باید مثبت باشد',
    'account.deposit.empty_txid': 'این شناسه تراکنش وجود ندارد یا وارد نشده است',
    'account.deposit_address.invalid_address_format': 'فرمت آدرس واریزی صحیح نیست',
    'account.deposit_address.doesnt_support_cash_address_format': 'ارز مورد نظر از پول نقد پشتیبانی نمی‌کند',
    'account.withdraw.non_integer_limit': 'محدودیت مقدار ارسالی نمی‌تواند به شکل اعداد صحیح باشد',
    'account.withdraw.invalid_limit': 'محدوده صحیح نیست',
    'account.withdraw.non_positive_page': 'مقدار صفحه باید مثبت باشد',
    'account.withdraw.non_integer_otp': 'مقدار رمز عبور یک بار مصرف نمی‌تواند به شکل اعداد صحیح باشد',
    'account.withdraw.empty_otp': 'رمز عبور یک بار مصرف وجود ندارد یا وارد نشده',
    'account.withdraw.empty_rid': 'وجود ندارد یا وارد نشده Rid',
    'account.withdraw.non_decimal_amount': 'مقدار ارسالی نمی‌تواند به شکل اعداد اعشاری باشد',
    'account.withdraw.non_positive_amount': 'مقدار وارد شده باید مثبت باشد',
    'account.deposit.not_permitted': 'واریزی تنها پس از تأیید شماره تلفن مجاز است',
    'account.withdraw.not_permitted': 'برای برداشت، لطفاً مراحل تأیید را انجام دهید',
    ...
    'market.order.non_integer_limit': 'محدودیت مقدار ارسالی نمی‌تواند به شکل اعداد صحیح باشد',
    ...
    'market.order.non_decimal_volume': 'مقدار حجم معامله نمی‌تواند به شکل اعداد اعشاری باشد',
    'market.order.non_positive_volume': 'مقدار حجم معامله باید مثبت باشد',
    'market.order.invalid_type': 'نوع سفارش صحیح نیست',
    'market.order.non_decimal_price': 'مقدار حجم ارسالی نمی‌تواند به شکل اعداد اعشاری باشد',
    'market.order.non_positive_price': 'مقدار حجم باید مثبت باشد',
    'market.order.non_integer_id': 'حجم آی دی ارسالی نمی‌تواند به شکل اعداد صحیح باشد',
    'market.order.empty_id': 'آی دی موجود نیست یا وارد نشده',
    'market.trade.non_integer_limit': 'محدودیت حجم ارسالی نمی‌تواند به شکل اعداد صحیح باشد',
    'market.trade.invalid_limit': 'محدوده صحیح نیست',
    'market.trade.non_integer_timestamp': 'مقدار برچسب زمانی ارسالی نمی‌تواند به شکل اعداد صحیح باشد',
    ...
    'market.trade.not_permitted': 'برای فعال کردن تبادل لطفاً مراحل تأیید را انجام دهید',
    ...
    'public.order_book.non_integer_ask_limit': 'مقدار محدودیت درخواست نمی‌تواند به شکل اعداد صحیح باشد',
    'public.order_book.invalid_ask_limit': 'محدودیت درخواست صحیح نیست',
    'public.order_book.non_integer_bid_limit': 'مقدار محدودیت پیشنهاد نمی‌تواند به شکل اعداد صحیح باشد',
    'public.order_book.invalid_bid_limit': 'محدودیت پیشنهاد صحیح نیست',
    'public.trade.non_integer_limit': 'محدودیت مقدار ارسالی نمی‌تواند به شکل اعداد صحیح باشد',
    'public.trade.invalid_limit': 'محدوده صحیح نیست',
    'public.trade.non_positive_page': 'مقدار صفحه باید مثبت باشد',
    'public.trade.non_integer_timestamp': 'مقدار برچسب زمانی ارسالی نمی‌تواند به شکل اعداد صحیح باشد',
    'public.trade.invalid_order_by': 'سفارش صحیح نیست',
    'public.market_depth.non_integer_limit': 'محدودیت مقدار ارسالی نمی‌تواند به شکل اعداد صحیح باشد',
    'public.market_depth.invalid_limit': 'محدوده صحیح نیست',
    'public.k_line.non_integer_period': 'محدودیت مقدار ارسالی نمی‌تواند به شکل اعداد صحیح باشد',
    'public.k_line.invalid_period': 'محدوده صحیح نیست',
    'public.k_line.non_integer_time_from': 'محدودیت مقدار ارسالی نمی‌تواند به شکل اعداد صحیح باشد',
    'public.k_line.empty_time_from': 'پارامتر زمان-از-سمت وجود ندارد یا وارد نشده است',
    'public.k_line.non_integer_time_to': 'محدودیت مقدار ارسالی نمی‌تواند به شکل اعداد صحیح باشد',
    'public.k_line.empty_time_to': 'پارامتر زمان-به-سمت وجود ندارد یا وارد نشده است',
    'public.k_line.non_integer_limit': 'محدودیت مقدار ارسالی نمی‌تواند به شکل اعداد صحیح باشد',
    ...
    'password.strength.tip.letter': 'حداقل یک حرف بزرگ و یک حرف کوچک داشته باشد',
    ...
    'account.beneficiary.invalid_pin': 'کد وارد شده صحیح نمی باشد، در خواست شما حذف شد',
