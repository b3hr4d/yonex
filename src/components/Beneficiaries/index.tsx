...
class BeneficiariesComponent extends React.Component<Props, State> {
    ...
    public render() {
        const { currency, type, beneficiaries, beneficiariesAddData } = this.props;
        const {
        ...
        return (
            <div className="pg-beneficiaries">
                ...
                {isOpenFailModal && <BeneficiariesFailAddModal handleToggleFailModal={this.handleToggleFailModal} />}
            </div>
        );
    }
